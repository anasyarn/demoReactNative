...
const paymentType = ['Wallet', 'Credit Card', 'Bank', 'Cash'];
                  ...
                  <View style={{ ...styles.tableRow }}>
                    ...
                    >
                      ...
                      {order.card.type != 'cash' && (
                        <Text style={styles.tableCell2}>
                          XXXX XXXX XXXX {order.card.card_number}
                        </Text>
                      )}
                      {order.card.type == 'cash' && (
                        <Text style={styles.tableCell2}>
                          ...
                          renderItem={({ item, index }) => (
                            <TouchableOpacity
                              style={{
                                ...
                                borderRadius: 5,
                                backgroundColor:
                                  this.state.selectedPaymentOption === item
                                    ? 'green'
                                    : '#fff',
                                elevation: 5,
                                margin: 10,
                              ...
                              onPress={() =>
                                this.setState({ selectedPaymentOption: item })
                              }
                            >
                              {item === 'Wallet' ? (
                                <AntIcon
