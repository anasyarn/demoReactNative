...
class DirectionsDefaultScreen extends Component {
...
<View style={styles.mainbody}>
      ...
      latitudeDelta: 1.9222,
      longitudeDelta: 1.9221,
                  }}
...
<Text style={{fontSize:28, color:"#000", fontWeight:"bold", textAlign:"center"}}>{this.state.distance_in_km}</Text>
              ...
              //    }} 
                 style={{width:"90%", backgroundColor:"#26b050", paddingVertical:10}}>
                            <Text style={{textAlign:"center", color:"#fff", fontSize:22}}>Confirm</Text>
                          </TouchableOpacity>
             </View>
             <View style={{width:"100%", height:deviceHeight/2.5, backgroundColor:"#fff", position:"absolute", bottom:0, alignContent:"center", alignItems:"center"}}>
              <ScrollView style={{width:"90%"}} showsVerticalScrollIndicator={false}>
              <View style={{width:"100%"}}>
            
            <View style={{width:"100%", marginTop:10, borderBottomColor:"#e9e9e9", borderBottomWidth:1}}>
  <RNPickerSelect
  value={this.state.cm}
  placeholder={cm_placeholder}
          onValueChange={(value) => this.setState({cm:value})}
          style={{
  ...
  <View style={{width:"50%",paddingVertical:10,marginVertical:10, borderRadius:25, borderColor:"#e9e9e9", borderWidth:1, backgroundColor:"#fff"}}>
<Text style={{fontSize:28, color:"#000", fontWeight:"bold", textAlign:"center"}}>$ 187</Text>
              </View>
  </View>
  <View style={{width:"100%", alignContent:"center", alignItems:"center", marginVertical:20}}>
              {/* <View style={{width:"50%",paddingVertical:10,marginVertical:10, borderRadius:25, borderColor:"#e9e9e9", borderWidth:1, backgroundColor:"#fff"}}>
<Text style={{fontSize:28, color:"#000", fontWeight:"bold", textAlign:"center"}}>{this.state.distance_in_km}</Text>
              </View> */}
...
export default connect(store => ({ app: store.app }), { logout, setAppState, i18nT })(DirectionsDefaultScreen);
